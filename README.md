<img src="https://media.giphy.com/media/QDjpIL6oNCVZ4qzGs7/giphy.gif" alt="AI GIF"/>


## 🌌 About Me

I'm a fullstack software engineer, backend focused, with a passion for building applications. I'm currently diving into AI/ML Engineering and exploring new languages for fun ;)
...
🚀 **Diving into AI/ML & LLMs** – Studying deeply about **Neural Networks, LLMs and AI Engineering**.  
🛠️ **Exploring new languages** – Currently **tinkering with Go, C and C++** for high-performance applications.  
💡 **Building cutting-edge projects** – Bridging **AI, automation, and full-stack tech** into something game-changing.  
...
📧 **Email**: [helio.lucio.jr@hotmail.com](mailto:helio.lucio.jr@hotmail.com)  
💼 **LinkedIn**: [linkedin.com/in/hlucio](https://www.linkedin.com/in/hlucio)  

📬 **DM me if you want to talk tech, collab, or just nerd out!** 🚀  

![Funny Dev GIF](https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif)
